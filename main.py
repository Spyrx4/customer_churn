...
try:
    model_sim = joblib.load("artifacts/models/xgb_ros.pkl")
    preprocess_sim = joblib.load("artifacts/preprocessing_fe/preprocessing_artifacts.joblib")
except Exception as e:
    st.error(f"Error loading artifacts: {e}")
    model_sim, preprocess_sim = None, None
...
with tabs[0]:
    if model_sim and preprocess_sim:
